...
import 'add_crypto_wallet_model.dart';
export 'add_crypto_wallet_model.dart';

class AddCryptoWalletWidget extends StatefulWidget {
  const AddCryptoWalletWidget({Key? key}) : super(key: key);

  @override
  _AddCryptoWalletWidgetState createState() => _AddCryptoWalletWidgetState();
}

class _AddCryptoWalletWidgetState extends State<AddCryptoWalletWidget> {
  late AddCryptoWalletModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddCryptoWalletModel());
              ...
              Container(
                ...
                child: FutureBuilder<List<CryptoRow>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<CryptoRow> listViewCryptoRowList = snapshot.data!;
                    return ListView.builder(
                      ...
                      itemBuilder: (context, listViewIndex) {
                        final listViewCryptoRow =
                            listViewCryptoRowList[listViewIndex];
                        return Padding(

...
class HomeyWidget extends StatefulWidget {
  const HomeyWidget({Key? key}) : super(key: key);

  @override
  _HomeyWidgetState createState() => _HomeyWidgetState();
}
                        ...
                        child: StreamBuilder<List<PackagesRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<PackagesRecord> listViewPackagesRecordList =
                                snapshot.data!;
                            if (listViewPackagesRecordList.isEmpty) {
